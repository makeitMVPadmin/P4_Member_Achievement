      ...
      <ChakraProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/resource" element={<ResourcePage setSavedBookmarks={setSavedBookmarks} />}  />
            <Route path="/bookmarked" element={<BookMarkedPage bookmarkedResources={savedBookmarks} />}  />
