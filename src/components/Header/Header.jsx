    ...
    <div className="header">
      <div className="header__navigation">
        <div className="header__main-icon">
          <img src={communitiLogo} alt="Communiti" className="header__main-image"/>
        </div>
        ...
        <div className="header__icons header__icons--mobile-hide">
          <img src={communitiesLogo} alt="Communities" className="header__images"/>
      ...
      <div className="header__user-container header__icons--mobile-hide">
        ...
        <img src={downCarrot} alt="Down Arrow" className="header__down-carrot"/>
      </div>
