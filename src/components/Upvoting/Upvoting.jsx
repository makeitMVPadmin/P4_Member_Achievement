...
const getIconSize = () => {
    ...
    return { width: "1.5rem", height: "1.5rem" }; // Tablet & Desktop
};
...
function Upvoting() {
    ...
    const [upvoteColors, setUpvoteColors] = useState("primary:#000000,secondary:#ffffff,tertiary:#ffffff");
    const [downvoteColors, setDownvoteColors] = useState("primary:#000000,secondary:#ffffff,tertiary:#ffffff");
